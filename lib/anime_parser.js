...
// Main mirrors (Updated)
const BASE_URL = 'https://hianime.to/';
const BASE_URL2 = 'https://ww6.gogoanime2.org/';

// ✅ New Working AJAX CDN (same path structure as gogocdn)
const ajax_url = 'https://ww6.gogoanime2.org/';

// Anime info (unchanged if still functional)
const anime_info_url = 'https://ww6.gogoanime2.org/category/';
const anime_movies_path = '/anime-movies.html';
const popular_path = '/popular.html';
const new_season_path = '/new-season.html';

// Rebuild AJAX endpoints using the new ajax_url
...
// Seasons backup
const seasons_url = 'https://ryuk.to/sub-category/';

// Streaming Referer and base (updated mirror)
const Referer = 'https://gogoplay.io/';
const goload_stream_url = 'https://goload.la/streaming.php';
export const DownloadReferer = 'https://goload.la/';
